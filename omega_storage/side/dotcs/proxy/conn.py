...
import platform
system_name={"Linux":("lib","linux",".so",ctypes.CDLL),"Windows":("","windows",".dll", ctypes.cdll.LoadLibrary),"Darwin":("","macos",".dylib",ctypes.CDLL)}[platform.system()]
machine=platform.machine()
if machine=="x86_64":
    machine="amd64"
libpath=f"{system_name[0]}fbconn_{system_name[1]}_{machine}{system_name[2]}"
