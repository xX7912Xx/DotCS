...
try:
    ...
    def revMsg():
        global timeSpentFBRun, msgRecved, msgList, timesErr, connected, connID
                ...
                try:
                    ...
                    if ("recv on closed connection" in str(err)) or ("id 0 out of range 0" in str(err)):
                        ...
                        try:
                            ...
                            color("§4Cannot reconnect to FB program, exiting.")
                            exitChatbarMenu()
                        continue
                        # exitChatbarMenu()
                    continue
    ...
    if __name__ == "__main__":
        version = "Community v0.7.0 beta 1 bugfix 1" # 设置版本号
        ...
        with open("server.txt") as file:
            ...
            if serverPassword == "123456":
                FBconfig["serverPassword"] = input("请输入租赁服密码, 若没有, 输入000000: ")
                serverPassword = FBconfig["serverPassword"]
