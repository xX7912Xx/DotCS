version = "Community v0.6.3 beta 1"
...
class NeteaseServerWS(object):
    ...
    def start(self):
        global time_old, needToGet, target, server, connected, processing, server, sender, timeGameH, timeGameM, timesErr, robotname, adminhigh, needToGetScore, score
