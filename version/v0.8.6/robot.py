...
try:
    ...
    def QRcode(text: str, where: str = "console", who: str | None = None) -> None:
        ...
        返回: None
        """
        if where != "console" or where != "server":
        ...
        while True:
            try:
                try:
                    ...
                    msgLastRecvTime = time.time()
                    if packetType == 39 or packetType == 40 or packetType == 111 or packetType == 123 or packetType == 58 or packetType == 108:
                        continue
                    if not msgRecved:
